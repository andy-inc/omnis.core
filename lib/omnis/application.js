...
Application.prototype.inject = function(ns, fn){
    ...
    return this._di.inject(ns, null, fn);
};
...
Application.prototype.plugin = function(plugin){
    ...
    var self = this;
    return this.mapSeries(plugin, function(pl){
        return self._di.register(pl);
    });
};
...
Application.prototype._express = function(){
    ...
    self._addMiddleware('middleware:after:error');
...
Application.prototype.$root = function(){
    return this._omnis.$root();
};
